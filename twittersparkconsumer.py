...
if __name__ == "__main__":
    ...
    ssc = StreamingContext(sc, 3) #let it wait for 3 seconds to consume the next package of tweets
  
    kafkaStream = KafkaUtils.createStream(ssc, "localhost:2181", "consumer-group", {"tweets": 1})
